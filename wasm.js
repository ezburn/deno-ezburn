...
ezbuild in this environment because ezbuild relies on this invariant. This
is not a problem with ezbuild. You need to fix your environment instead.
`);
...
var ensureServiceIsRunning = () => {
  return initializePromise || startRunningService("ezbuild.wasm", void 0, true);
};
var initialize = async (options) => {
  ...
  initializePromise = startRunningService(wasmURL || "ezbuild.wasm", wasmModule, useWorker);
